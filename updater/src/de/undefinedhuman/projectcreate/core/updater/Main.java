package de.undefinedhuman.projectcreate.core.updater;
...
import de.undefinedhuman.projectcreate.core.engine.file.FileUtils;
...
import de.undefinedhuman.projectcreate.core.engine.utils.Version;
import de.undefinedhuman.projectcreate.core.updater.utils.DownloadUtils;
import de.undefinedhuman.projectcreate.core.updater.utils.InstallationUtils;
import de.undefinedhuman.projectcreate.core.updater.window.HeadlessApplicationListener;
...
public class Main extends JFrame {
    ...
    private static final String DOWNLOAD_LAUNCHER_URL = "http://playprojectcreate.com/launcher/";
    ...
    public void updateLauncher() {
        ...
        InstallationUtils.loadInstallationDirectory(config = new FsFile(projectDotFile, "updater.config", Files.FileType.External), DEFAULT_INSTALLATION_PATH, installationPath, version);
        ...
        if(!(installationFile.exists() && version.getVersion().equals(maxVersion) && DownloadUtils.fetchFileSize(downloadUrl) == installationFile.length())) {
            ...
            installationFile = new FsFile(installationDirectory, maxVersion + ".jar", Files.FileType.Absolute);
            try {
