package de.undefinedhuman.projectcreate.core.launcher;
...
public class Main extends JFrame {
    ...
    public Main() {
        ...
        long diskSize = Gdx.files.external("/").file().getUsableSpace();
        Log.info("Disk Size", diskSize);
        long memorySize = ((OperatingSystemMXBean) ManagementFactory.getOperatingSystemMXBean()).getTotalPhysicalMemorySize();
        Log.info("Total memory", memorySize);
    ...
    public void setUIComponentProperties() {
