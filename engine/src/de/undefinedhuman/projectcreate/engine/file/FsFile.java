...
public class FsFile extends FileHandle {
    ...
    public FsFile(FileHandle parentFile, String fileName) {
        super(parentFile.path() + Variables.FILE_SEPARATOR + fileName, parentFile.type());
    }

    public FsFile(FsFile parentFile, String fileName) {
        super(parentFile.path() + Variables.FILE_SEPARATOR + fileName, parentFile.type());
    }
