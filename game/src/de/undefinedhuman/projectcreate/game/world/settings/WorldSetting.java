package de.undefinedhuman.projectcreate.game.world.settings;

import de.undefinedhuman.projectcreate.game.world.Biome;
...
public enum WorldSetting {
    ...
    DEV(2, Biome.GRASSLAND, Biome.DESERT), SMALL(10, Biome.GRASSLAND, Biome.DESERT), NORMAL(15, Biome.GRASSLAND, Biome.DESERT), BIG(25, Biome.GRASSLAND, Biome.DESERT);
